...
/opt/jboss/jboss-full/bin/client -u admin -p admin 'osgi:install -s mvn:com.atomikos/transactions-jdbc/3.9.3' && \
/opt/jboss/jboss-full/bin/client -u admin -p admin 'osgi:install -s mvn:com.atomikos/transactions-jta/3.9.3' && \
/opt/jboss/jboss-full/bin/client -u admin -p admin 'osgi:install -s mvn:com.atomikos/atomikos-util/3.9.3' && \
/opt/jboss/jboss-full/bin/client -u admin -p admin 'osgi:install -s mvn:com.atomikos/transactions-osgi/3.9.3' && \
...
/opt/jboss/jboss-full/bin/client -u admin -p admin 'osgi:install -s mvn:org.mybatis/mybatis-spring/1.2.3' && \
...
/opt/jboss/jboss-full/bin/client -u admin -p admin 'osgi:install -s mvn:org.codehaus.jackson/jackson-xc/1.9.0' && \
/opt/jboss/jboss-full/bin/client -u admin -p admin 'osgi:install -s mvn:com.fasterxml.jackson.jaxrs/jackson-jaxrs-json-provider/2.4.0' && \
/opt/jboss/jboss-full/bin/client -u admin -p admin 'osgi:install -s mvn:com.fasterxml.jackson.core/jackson-annotations/2.4.0' && \
/opt/jboss/jboss-full/bin/client -u admin -p admin 'osgi:install -s mvn:com.fasterxml.jackson.core/jackson-core/2.4.0' && \
/opt/jboss/jboss-full/bin/client -u admin -p admin 'osgi:install -s mvn:com.fasterxml.jackson.core/jackson-databind/2.4.0' && \
/opt/jboss/jboss-full/bin/client -u admin -p admin 'osgi:install -s mvn:com.fasterxml.jackson.jaxrs/jackson-jaxrs-base/2.4.0' && \
/opt/jboss/jboss-full/bin/client -u admin -p admin 'osgi:install -s mvn:org.apache.cxf/cxf-rt-rs-security-cors/3.0.4' && \
/opt/jboss/jboss-full/bin/client -u admin -p admin 'osgi:install -s mvn:org.apache.cxf/cxf-rt-frontend-jaxrs/3.0.4' && \
